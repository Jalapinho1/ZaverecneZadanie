...
<form class="w-75 p-3 mb-5 mt-5 mx-auto shadow p-3 mb-5 bg-white rounded" id="uploadForm" action="./teamview.php" style="background-color: rgba(0,0,0,.05) !important;" method="POST" enctype="multipart/form-data">
